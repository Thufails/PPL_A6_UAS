...
$row = query("SELECT * FROM dataproduk WHERE id = $id_produk")[0];

//cek apakah tombol submit sudah ditekan atau belum
if ( isset($_POST["pesan"]) ) {
    // cek apakah data berhasil ditambahkan atau tidak
    if ( membuat_data_pesanan($_POST) > 0) {
        echo "
        <script>
            alert('Menunggu Konfirmasi Kasir')
            document.location.href = '../pesanan/melihatpesanan(Pembeli).php';
        </script>
        ";
    } else {
        echo "
...
<body>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                <h3 style="text-align: center;">Pembeli</h3>
            <div class="box-container">
            <?php  ?>
                <div class="box" style="text-align: center;">
                    <img style="height: 250px;"src="../daftar_produk/images/<?=$row["gambar_produk"]?>" alt="">
                    <h3>
                        <?= $row["nama_produk"]?>
                    </h3>
                    <div style="color:azure; font-size:medium;"class="price"><?= $row["harga_produk"]?></div>
                </div>
            <?php  ?>
            </div>
...
<h1 style="color:white; text-align: center;">Membuat Data Pesanan</h1>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="row g-2">
        <input type="hidden" name="id_produk" id="id_produk" value="<?= $row["id"];?>">
        <div class="col-12">
        ...
        <div class="col-12">
            ...
            <input type="text" name="jumlah_produk" id="jumlah_produk" class="form-control" required>
        </div>
        <div class="col-12">
        ...
        <button type="submit" name="pesan" class="btn btn-primary btn-sm">Pesan</button>
        </div>
        <br>
    </form>
    </div>
