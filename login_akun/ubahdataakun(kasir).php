...
if ( isset($_POST["simpan"]) ) {
    ...
    if ( mengedit_data_akunKasir($_POST) > 0) {
        ...
        <script>
            ...
            document.location.href = 'profilakunkasir.php';
        </script>
        ";
    } else {
        echo "
...
<h1 style="text-align: center;">Mengedit Data Akun Kasir</h1>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="row g-2">
        ...
        <button type="submit" name="" class="btn btn-primary btn-sm"><a href="profilakunkasir.php" style="color:white; text-decoration: none;">Kembali</a></button>
        </div>
        <br>
    </form>
    </div>