...
if ( isset($_POST["simpan"]) ) {
    ...
    if ( mengedit_data_akunPembeli($_POST) > 0) {
        echo "
        <script>
            alert('data anda telah berhasil diubah!')
            document.location.href = 'profilakunpembeli.php';
        </script>
        ";
    } else {
        echo "
...
<body>
<h1 style="text-align: center;">Mengedit Data Akun Pembeli</h1>
    ...
    <form action="" method="post" enctype="multipart/form-data" class="row g-2">
        ...
        <button type="submit" name="" class="btn btn-primary btn-sm"><a href="profilakunpembeli.php" style="color:white; text-decoration: none;">Kembali</a></button>
        </div>
        <br>
    </form>
    </div>