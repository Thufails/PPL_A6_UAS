    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="membuatdaftar(Pemilik).php" class="btn" style="color: white;">Tambah Produk</a>
            </div>
        ...
        <div class="box-container">
            <?php foreach ($dataproduk as $row) : ?>
                <div class="box">
                    ...
                    <button class="btn">
                        <a href="mengubahdaftar(Pemilik).php?id=<?= $row["id"]; ?>" style="text-decoration: none;">Edit</a>
                    </button>
                </div>
            <?php endforeach; ?>
